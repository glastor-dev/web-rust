      ...
      <div className="fixed top-0 left-0 -z-50 opacity-0 pointer-events-none overflow-hidden">
        ...
        >
          ...
          <div className="border-b border-[#00ff664d] pb-8 mb-8 flex justify-between items-end">
            <div>
              <h1 className="text-5xl font-black uppercase tracking-tighter mb-2 text-[#ffffff]">
                GLASTOR®
              </h1>
              <p className="text-[#71717a] text-sm tracking-widest uppercase">
          ...
          <div className="flex-1">
            <p className="text-brand text-sm tracking-widest uppercase mb-4 font-bold border-b border-[#00ff664d] pb-2">
            ...
            <div className="flex flex-col gap-4">
              {selectedModules.length === 0 ? (
                ...
                selectedModules.map((module) => (
                  <div
                    key={module.id}
                    className="flex justify-between items-start border-b border-[#ffffff0d] pb-4"
                  >
                    <div className="pr-8">
          ...
          <div className="mt-12 border-t border-[#00ff6680] pt-8 flex justify-end">
            <div className="w-1/2 bg-[#ffffff0d] p-6 border border-[#ffffff1a]">
              <p className="text-[#a1a1aa] text-xs tracking-widest uppercase mb-2">
