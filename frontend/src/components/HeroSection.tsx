...
// Lazy load for OffBrandOrb (heavy canvas component) - File missing
          ...
          >
            {[...clientLogos, ...clientLogos].map((logo, idx) => (
              <img
                ...
                src={logo.src}
                alt={logo.alt}
                className="h-6 md:h-8 w-auto object-contain brightness-0 invert opacity-40 hover:brightness-100 hover:invert-0 hover:opacity-100 transition-all duration-500 hover:scale-105 cursor-pointer"
              />
            ))}
          </motion.div>
        </div>
