...
const noHacemos = [
  {
    ...
    desc: 'No construimos sobre temas prefabricados. Arquitectura 100% a medida de tus operaciones.',
  },
  {
    title: 'Deuda Técnica',
    desc: 'No sacrificamos arquitectura a largo plazo por cerrar un sprint 2 semanas antes.',
  },
  {
    title: 'Promesas sin Datos',
    desc: 'No inflamos expectativas. Hablamos con métricas duras (Latencia p99, Uptime, Costos Cloud).',
  },
];
          ...
          {noHacemos.map((item, idx) => (
            ...
            >
              <Card className="p-8 border-red-500/20 bg-red-500/5 hover:border-red-500/40 transition-colors rounded-none h-full shadow-[0_0_15px_rgba(239,68,68,0.05)]">
                ...
                <h3 className="text-white font-bold tracking-tight mb-4 text-xl">{item.title}</h3>
