    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16 mb-32 max-w-4xl mx-auto">
        ...
        <div className="group">
          ...
          <TextRevealGSAP
            text="Especialista en arquitecturas de alto rendimiento (Rust/Go). Obsesionado con reducir la latencia a nivel de ciclo de reloj y eliminar la deuda técnica antes de que nazca."
          ...
          <div className="flex gap-4">
            ...
            >
              <img src="/icons/github.svg" alt="GitHub" width="18" height="18" className="invert" />
            </a>
            <a href="#" className="text-zinc-500 hover:text-[#0077b5] transition-colors">
              <svg
                viewBox="0 0 24 24"
                width="18"
                height="18"
        ...
        <div className="group">
          <div className="aspect-square bg-zinc-900 overflow-hidden relative mb-6 border border-white/5 flex items-center justify-center">
            ...
            <span className="text-zinc-700 font-mono text-xs uppercase tracking-widest text-center px-8">
              Buscando talento <br />
              con alma de Rust
            </span>
          </div>
