...
export function RustServicesSection() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="glass-panel p-8 border-editorial group hover:bg-brand/5 hover:border-brand/30 transition-all duration-300 flex flex-col h-full"
            >
