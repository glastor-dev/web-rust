...
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from '../components/reutilizables/accordion';
...
export default function Servicios() {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <PageHero 
        title={<>TRANSFORMAMOS<br /><span className="text-brand">EL CAOS<br/>OPERATIVO.</span></>}
        description="No escribimos código por moda. Diseñamos infraestructuras en Rust para que tus servidores cuesten un 60% menos y tus usuarios nunca vean una pantalla de carga."
      ...
      <section id="como-escalamos" className="py-32 px-6 md:px-12 max-w-7xl mx-auto border-t border-white/10 mt-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white mb-6 leading-[0.9]">
              ¿CÓMO ESCALAMOS<br /><span className="text-brand">TU APP?</span>
            </h2>
            <p className="text-zinc-400 text-lg leading-relaxed mb-8">
              No lo hacemos tirando dinero en servidores de AWS y rezando. Lo hacemos reescribiendo los cuellos de botella en <strong className="text-white">Rust</strong>.
            </p>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  JavaScript maneja un hilo a la vez. Rust usa todos los núcleos del procesador al mismo tiempo sin miedo a colisiones en memoria. Eso significa manejar 10,000 requests concurrentes donde Node colapsa en 500.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger>02/ Eliminación de Máquina Virtual</AccordionTrigger>
                <AccordionContent>
                  Killed the Garbage Collector. Al compilar directamente a binario nativo, no hay pausas para limpiar memoria. Latencia plana y constante. Siempre.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                <AccordionTrigger>03/ Seguridad de Memoria</AccordionTrigger>
                <AccordionContent>
                  Si compila, no hay segmentation faults. Todo el ecosistema de Rust previene errores de memoria en tiempo de compilación. Tu backend literalmente no puede fallar por las razones habituales.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <div className="relative pt-4">
             <Card className="rounded-none border-editorial p-8 bg-black">
                <h3 className="text-zinc-300 font-mono text-sm uppercase tracking-widest mb-8 border-b border-white/10 pb-4">Telemetría de Escalado</h3>
                <div className="space-y-8 font-mono text-xs text-zinc-500">
                  
                  {/* Node.js Bar */}
                  <div>
                    <div className="flex justify-between mb-2"><span className="text-white">Legacy Node.js</span><span className="text-red-500">2.4GB RAM / 100 RPS</span></div>
                  ...
                  {/* Rust Bar */}
                  <div>
                    <div className="flex justify-between mb-2"><span className="text-white">Glastor Rust Core</span><span className="text-brand">40MB RAM / 10,000 RPS</span></div>
