...
export default function ProductDetail() {
    ...
    return (
      <div className="bg-[#050505] min-h-screen text-white pt-32 pb-24 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/tienda" className="bg-brand text-black px-6 py-3 font-bold uppercase text-sm">
            Volver a la tienda
          </Link>
        </div>
      </div>
  ...
  // En caso de que haya pocas fotos, duplicamos la principal para el mockup visual (hasta 4)
  const gallery = rawGallery.length > 1 ? rawGallery : Array(4).fill(rawGallery[0]);
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-24">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tighter leading-none mb-6">
              {product.name}
            </h1>
            ...
            <button className="text-brand text-xs font-bold uppercase tracking-widest hover:underline self-start mb-8">
            ...
            <div className="mt-auto bg-[#080808] border border-zinc-800 rounded-xl p-6 sm:p-8">
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Envío <span className="text-brand font-bold">GRATIS</span> el martes, 14 de julio.
                  <br />
                  Pedido antes de: <span className="text-brand font-bold">7 hrs 9 mins.</span>
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-4">
                ...
                <button
                  ...
                  className="grow bg-[#050505] border border-brand text-brand hover:bg-brand hover:text-black transition-colors font-black uppercase text-sm tracking-widest py-3.5 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  AÑADIR AL CARRITO
                </button>
              </div>
              ...
              <button className="w-full flex justify-center items-center gap-2 text-xs font-bold uppercase tracking-widest text-zinc-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex gap-8 border-b border-zinc-800 mb-8 overflow-x-auto pb-4 hide-scrollbar">
            {[
              ...
              <button
                ...
                className={`text-xs sm:text-sm font-black uppercase tracking-widest whitespace-nowrap pb-4 relative transition-colors ${
          ...
          {activeTab === 'RESUMEN' && (
            ...
            >
              ...
              <div>
                <h3 className="text-2xl sm:text-3xl font-black uppercase tracking-tighter mb-6">
                  ACERCA DEL MODELO
                </h3>
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      product.description ||
                      `
                    <p>El ${product.name} se distingue por su ingeniería de vanguardia dentro del innovador <strong class="text-white"> sistema XGT® de 40V max de Makita</strong>, diseñado para dominar las aplicaciones de alta demanda. Este modelo incorpora un <strong class="text-white">motor sin escobillas</strong> que, junto con el control de velocidad constante, aplica potencia adicional automáticamente bajo carga, asegurando un rendimiento óptimo y consistente.</p>
                    <p>Su diseño se centra en la resistencia y la protección, con <strong class="text-white">engomado sobre la carcasa de engranaje y la batería</strong> que resguarda las superficies delicadas de posibles daños. Además, características como el <strong class="text-white">agarre de hule suave</strong>, el mango superior y el <strong class="text-white">arranque suave</strong> no solo aumentan la comodidad y el control del operador, sino que también prolongan la vida útil del equipo, haciendo de esta herramienta una inversión inteligente y duradera.</p>
                  `,
                  }}
                />
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-4 text-sm text-zinc-400 marker:text-brand">
                  <li>
                    ...
                    Ofrece una solución sin cables para una variedad de aplicaciones industriales,
                    maximizando la movilidad y flexibilidad en el lugar de trabajo.
                  </li>
                  <li>
                    <strong className="text-white">Control de Velocidad Preciso:</strong> Equipada
                    con un selector y gatillo de velocidad variable que permite al usuario igualar
                    la velocidad a la aplicación específica, garantizando acabados impecables.
                  </li>
                  <li>
                    <strong className="text-white">Diseño Robusto y Protector:</strong> Cuenta con
                    engomado sobre la carcasa de engranajes y la batería, diseñado para ayudar a
                    proteger tanto la herramienta como las superficies de trabajo delicadas.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong className="text-white">Tecnología de Protección Extrema (XPT™):</strong>{' '}
                    Ingeniería avanzada para proporcionar una mayor resistencia contra el polvo y el
                    agua, ideal para las condiciones más severas.
                  </li>
                  <li>
                    <strong className="text-white">Arranque Suave:</strong> Suprime la reacción de
                    inicio, facilitando arranques más fluidos y contribuyendo a una mayor
                    durabilidad del engranaje y el motor.
                  </li>
                </ul>
              </div>
            </motion.div>
          ...
          {activeTab === 'ESPECIFICACIONES' && (
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-4 text-sm text-zinc-300 marker:text-brand">
                ...
                <li>
                  <strong className="text-white">Tipo de Herramienta:</strong> Pulidora Inalámbrica
                  de 7"
                </li>
                <li>
                  <strong className="text-white">Plataforma de Batería:</strong> Makita XGT® 40V max
                </li>
                <li>
                  <strong className="text-white">Tipo de Motor:</strong> Sin Escobillas
                </li>
                <li>
                  <strong className="text-white">Velocidad Variable (sin carga):</strong> 0 - 2,200
                  RPM
                </li>
                <li>
                  <strong className="text-white">Diámetro de la Almohadilla:</strong> 7"
                </li>
                <li>
                  <strong className="text-white">Peso (con batería XGT® 40V max 4.0Ah):</strong> 7.7
                  lbs. (aproximadamente)
                </li>
                <li>
                  <strong className="text-white">Batería Incluida:</strong> 1x Batería XGT®
                  Litio-Ion de 40V max 4.0Ah
                </li>
                <li>
                  <strong className="text-white">Cargador Incluido:</strong> Sí
                </li>
                <li>
                  <strong className="text-white">Maleta de Transporte Incluida:</strong> Sí
                </li>
                <li>
                  <strong className="text-white">Tecnologías Destacadas:</strong> XGT®, XPT™, Motor
                  sin Escobillas, Control de Velocidad Constante, Arranque Suave.
                </li>
              </ul>
            </motion.div>
          )}
