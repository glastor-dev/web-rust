          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4 text-zinc-400">
                  <GlobeIcon size={20} />
                  <h3 className="font-mono text-xs uppercase tracking-widest">Páginas Vistas</h3>
                </div>
                <div className="text-5xl md:text-6xl font-black tracking-tighter text-white">
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4 text-zinc-400">
                  ...
                  <h3 className="font-mono text-xs uppercase tracking-widest">Duración Promedio</h3>
                </div>
                <div className="text-5xl md:text-6xl font-black tracking-tighter text-white">
