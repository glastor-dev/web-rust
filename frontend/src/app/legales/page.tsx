...
const SITE = 'https://glastor.es';

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  name: 'Portal Legal de Glastor',
  description:
    'Transparencia absoluta. Políticas de privacidad, aviso legal, cookies y normativas.',
  url: `${SITE}/legales`,
  publisher: {
    '@type': 'Organization',
    name: 'Glastor',
...
export default function Legales() {
  ...
  const copyAnchor = async (anchor: string) => {
    try {
      await navigator.clipboard.writeText(`${SITE}/legales#${anchor}`);
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 min-h-screen bg-[#050505] pt-32 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="mb-16">
          <h1 className="text-fluid-h2 font-extrabold tracking-tight text-white mb-4 leading-[0.9]">
