...
const arrepentimientoSchema = z.object({
  ...
  order_id: z.string().min(1, 'Número de orden/pedido es obligatorio'),
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {success ? (
          <Card className="p-8 bg-brand/5 border-brand text-center">
            <h2 className="text-2xl font-bold uppercase tracking-wider text-brand mb-4">
              Solicitud Recibida
            </h2>
          ...
          <Card className="bg-zinc-900 border border-white/10 p-8 rounded-none shadow-[0_0_15px_rgba(239,68,68,0.05)]">
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
              ...
              <div>
                ...
                />
                {errors.order_id && (
                  <p className="text-red-500 text-xs mt-2">{errors.order_id.message}</p>
                )}
              </div>
